...
export const addMessage = async ({ text, userID, threadID, sentByUser = 0 }) => {
  const result = await tryCatchAsync(() => axios.post('/api/postMessage', { threadID, userID, text, sentByUser }), 'Error adding message: ')
  return result
}
...
export const postThread = async ({ userID, threadName }) => {
  const result = await tryCatchAsync(() => axios.post('/api/postThread', { userID, threadName }), 'Error adding message: ')
  return result
}
...
export const patchTemperature = async ({ userID, threadID, newTemperature }) => {
  const result = await tryCatchAsync(() => axios.patch('/api/patchTemperature', { userID, threadID, newTemperature }), 'Error updating temperature: ')
  return result
}
...
export const patchTypingSpeed = async ({ userID, threadID, newTypingSpeed }) => {
  const result = await tryCatchAsync(() => axios.patch('/api/patchTypingSpeed', { userID, threadID, newTypingSpeed }), 'Error updating typing speed: ')
  return result
}
...
export const deleteThread = async ({ userID, threadID }) => {
  const result = await tryCatchAsync(() => axios.delete('/api/deleteThread', { data: { userID, threadID } }), 'Error deleting thread: ')
  return result
}