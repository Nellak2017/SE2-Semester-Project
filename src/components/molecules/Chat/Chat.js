...
import { ChatContainer, MessageContainer, LogoContainer, Message, } from './Chat.elements.js'
...
export default function Chat({ state, ...props }) {
	const { user = USERS.user, userLogo = <PiPlaceholderDuotone />, text = '', error = '', typingSpeed = 0, } = state || {}
	return (
